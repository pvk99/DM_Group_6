...
#Save to csv 
write.csv(CUSTOMER[1:100,], file = file.path("/cloud/project/Data","CUSTOMERS.1.csv"), row.names = FALSE)
write.csv(CUSTOMER[101:nrow(CUSTOMER),], file = file.path("/cloud/project/Data","CUSTOMERS.2.csv"), row.names = FALSE)
```
...
#Save to csv 
write.csv(ORDER[1:2000,], file = file.path("/cloud/project/Data","ORDERS.1.csv"), row.names = FALSE)
write.csv(ORDER[2001:nrow(ORDER),], file = file.path("/cloud/project/Data","ORDERS.2.csv"), row.names = FALSE)
```
