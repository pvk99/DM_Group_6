...
#Save to 2 csv files
write.csv(CATEGORY[1:15,], file = file.path("/cloud/project/Data","CATEGORY.1.csv"), row.names = FALSE)
write.csv(CATEGORY[16:nrow(CATEGORY),], file = file.path("/cloud/project/Data","CATEGORY.2.csv"), row.names = FALSE)
```
...
#Save to csv 
write.csv(SUPPLIER[1:15,], file = file.path("/cloud/project/Data","SUPPLIER.1.csv"), row.names = FALSE)
write.csv(SUPPLIER[16:nrow(SUPPLIER),], file = file.path("/cloud/project/Data","SUPPLIER.2.csv"), row.names = FALSE)
```
...
#Save to csv 
write.csv(SKU[1:15,], file = file.path("/cloud/project/Data","SKU.1.csv"), row.names = FALSE)
write.csv(SKU[16:nrow(SKU),], file = file.path("/cloud/project/Data","SKU.2.csv"), row.names = FALSE)
```
...
#Save to csv file
write.csv(PROMOTION[1:15,], file = file.path("/cloud/project/Data","PROMOTION.1.csv"), row.names = FALSE)
write.csv(PROMOTION[16:nrow(PROMOTION),], file = file.path("/cloud/project/Data","PROMOTION.2.csv"), row.names = FALSE)
```
...
ADS$AD_START_DATE <- (ADS$AD_START_DATE)
ADS$AD_END_DATE <- (ADS$AD_END_DATE)
...
#Save to csv 
write.csv(ADS[1:15,], file = file.path("/cloud/project/Data","ADS.1.csv"), row.names = FALSE)
write.csv(ADS[16:nrow(ADS),], file = file.path("/cloud/project/Data","ADS.2.csv"), row.names = FALSE)
```
...
CUSTOMER <- data.frame(
  CUSTOMER_ID = paste0("C", seq_len(200)),
  stringsAsFactors = TRUE
)
...
random_full_names <- randomNames(nrow(CUSTOMER))  

## Split full names into first and last names
split_names <- strsplit(random_full_names, ",")

## Extract first names
CUSTOMER$FIRST_NAME <- sapply(strsplit(random_full_names, ","), "[",2)

## Extract last names
CUSTOMER$LAST_NAME <- sapply(strsplit(random_full_names, ","), "[",1)
...
#Save to csv 
write.csv(CUSTOMER[1:15,], file = file.path("/cloud/project/Data","CUSTOMERS.1.csv"), row.names = FALSE)
write.csv(CUSTOMER[16:nrow(CUSTOMER),], file = file.path("/cloud/project/Data","CUSTOMERS.2.csv"), row.names = FALSE)
```
...
#Save to csv 
write.csv(ORDER_SHIPMENT[1:15,], file = file.path("/cloud/project/Data","ORDER_SHIPMENT.1.csv"), row.names = FALSE)
write.csv(ORDER_SHIPMENT[16:nrow(ORDER_SHIPMENT),], file = file.path("/cloud/project/Data","ORDER_SHIPMENT.2.csv"), row.names = FALSE)
```
...
#Save to csv 
write.csv(TRANSACTION[1:15,], file = file.path("/cloud/project/Data","TRANSACTIONS.1.csv"), row.names = FALSE)
write.csv(TRANSACTION[16:nrow(TRANSACTION),], file = file.path("/cloud/project/Data","TRANSACTIONS.2.csv"), row.names = FALSE)
```
