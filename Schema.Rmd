...
category_names <- c("Shirts","Innerwear", "Activewear","Shoes","Jackets","Accessories","Thermals","Pants","Jeans","Dress" )
...
#Save to csv file
write.csv(CATEGORY, file = "CATEGORY.csv", row.names = FALSE)
...
#Save to csv 
write.csv(SKU, file = "SKU.csv", row.names = FALSE)
```
...
#Save to csv 
write.csv(TRANSACTION, file = "TRANSACTION.csv", row.names = FALSE)
```
